  ...
  return (
    <div className="pt-8 sm:pt-16 sm:pl-[50px] sm:pb-[60px]">
      <div className="mb-14 sm:mb-12">
        <div data-aos="fade-right"  className="flex flex-row bg-white max-w-max rounded-full py-1 pl-4 pr-4 mb-5 sm:mb-2">
          <img src={LeafSVG} alt="" className="w-[25px] " loading="lazy" />
          <h5  className="icon home-icon">Who We Are</h5>
        </div>

        <h1 data-aos="fade-in" className="text-4xl text-center text-heading-color sm:text-left font-normal sm:font-normal w-full sm:text-[55px] sm:leading-[60px]">
          We produce and sell organic fertilizer
        </h1>

        <p data-aos="fade-in" className="text-left text-[18px] sm:text-left mt-3 sm:mt-6 mb-3">
